#!/usr/bin/env python3
"""
q10_embed_language_subtasks.py — hybride (embeddings + mini LLM refinement)

Analyseert *alleen donors die in q06 'Language practice or translation' kozen*.
...
if not lang_donors:
    print("⚠︎ Geen donors met Language in q06. Exporteer lege sheet met alleen headers.")
...
# 1) categorieën uit prototypes (volgorde = 1..K) → gebruiken voor namen én embeddings
...
# 10) donors zonder sub-labels → NONE_IDX (als aanwezig)
